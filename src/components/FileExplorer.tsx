    ...
    <div className="h-full flex flex-col bg-gray-900">
      ...
      <div className="bg-gray-800 border-b border-gray-700 p-4">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          {state.currentPath !== '/' && (
            <button
              className="inline-flex items-center justify-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 w-[90px]"
          ...
          {state.currentPath !== '/' && (
            <button
              className="inline-flex items-center justify-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 w-[90px]"
